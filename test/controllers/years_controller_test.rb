...
class YearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create year" do
    assert_difference('Year.count') do
      post years_url, params: { year: { datetimeSemanticZoomIn_id: @year.datetimeSemanticZoomIn_id, datetimeSemanticZoomOut_id: @year.datetimeSemanticZoomOut_id, name: @year.name, year: @year.year } }
    end
  ...
  test "should update year" do
    patch year_url(@year), params: { year: { datetimeSemanticZoomIn_id: @year.datetimeSemanticZoomIn_id, datetimeSemanticZoomOut_id: @year.datetimeSemanticZoomOut_id, name: @year.name, year: @year.year } }
