...
class MonthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create month" do
    assert_difference('Month.count') do
      post months_url, params: { month: { datetimeSemanticZoomIn_id: @month.datetimeSemanticZoomIn_id, datetimeSemanticZoomOut_id: @month.datetimeSemanticZoomOut_id, month: @month.month, name: @month.name } }
    end
  ...
  test "should update month" do
    patch month_url(@month), params: { month: { datetimeSemanticZoomIn_id: @month.datetimeSemanticZoomIn_id, datetimeSemanticZoomOut_id: @month.datetimeSemanticZoomOut_id, month: @month.month, name: @month.name } }
