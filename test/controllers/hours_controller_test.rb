...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post hours_url, params: { hour: { datetimeSemanticZoomIn_id: @hour.datetimeSemanticZoomIn_id, datetimeSemanticZoomOut_id: @hour.datetimeSemanticZoomOut_id, hour: @hour.hour, name: @hour.name } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { datetimeSemanticZoomIn_id: @hour.datetimeSemanticZoomIn_id, datetimeSemanticZoomOut_id: @hour.datetimeSemanticZoomOut_id, hour: @hour.hour, name: @hour.name } }
