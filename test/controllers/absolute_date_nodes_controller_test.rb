...
class AbsoluteDateNodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create absolute_date_node" do
    assert_difference('AbsoluteDateNode.count') do
      post absolute_date_nodes_url, params: { absolute_date_node: { artefacts_id: @absolute_date_node.artefacts_id, name: @absolute_date_node.name, normalized_name: @absolute_date_node.normalized_name } }
    end

    assert_redirected_to absolute_date_node_path(AbsoluteDateNode.last)
  end
  ...
  test "should update absolute_date_node" do
    patch absolute_date_node_url(@absolute_date_node), params: { absolute_date_node: { artefacts_id: @absolute_date_node.artefacts_id, name: @absolute_date_node.name, normalized_name: @absolute_date_node.normalized_name } }
    assert_redirected_to absolute_date_node_path(@absolute_date_node)
  end
