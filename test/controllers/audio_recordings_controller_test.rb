...
class AudioRecordingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create audio_recording" do
    assert_difference('AudioRecording.count') do
      post audio_recordings_url, params: { audio_recording: { durationInSeconds: @audio_recording.durationInSeconds, md5AtSave: @audio_recording.md5AtSave, name: @audio_recording.name, origionalArtefactFragments_id: @audio_recording.origionalArtefactFragments_id, waveformArray: @audio_recording.waveformArray } }
    end
  ...
  test "should update audio_recording" do
    patch audio_recording_url(@audio_recording), params: { audio_recording: { durationInSeconds: @audio_recording.durationInSeconds, md5AtSave: @audio_recording.md5AtSave, name: @audio_recording.name, origionalArtefactFragments_id: @audio_recording.origionalArtefactFragments_id, waveformArray: @audio_recording.waveformArray } }
