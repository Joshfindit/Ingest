...
class MinutesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create minute" do
    assert_difference('Minute.count') do
      post minutes_url, params: { minute: { datetimeSemanticZoomIn_id: @minute.datetimeSemanticZoomIn_id, datetimeSemanticZoomOut_id: @minute.datetimeSemanticZoomOut_id, minute: @minute.minute, name: @minute.name } }
    end
  ...
  test "should update minute" do
    patch minute_url(@minute), params: { minute: { datetimeSemanticZoomIn_id: @minute.datetimeSemanticZoomIn_id, datetimeSemanticZoomOut_id: @minute.datetimeSemanticZoomOut_id, minute: @minute.minute, name: @minute.name } }
