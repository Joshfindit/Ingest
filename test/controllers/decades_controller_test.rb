...
class DecadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create decade" do
    assert_difference('Decade.count') do
      post decades_url, params: { decade: { datetimeSemanticZoomIn_id: @decade.datetimeSemanticZoomIn_id, datetimeSemanticZoomOut_id: @decade.datetimeSemanticZoomOut_id, decade: @decade.decade, name: @decade.name } }
    end
  ...
  test "should update decade" do
    patch decade_url(@decade), params: { decade: { datetimeSemanticZoomIn_id: @decade.datetimeSemanticZoomIn_id, datetimeSemanticZoomOut_id: @decade.datetimeSemanticZoomOut_id, decade: @decade.decade, name: @decade.name } }
