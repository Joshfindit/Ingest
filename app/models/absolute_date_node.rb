...
#  has_many :in, :artefacts, type: :DATETIME_ARTEFACT_RECORDED_AT, model_class: :Artefact
  has_many :in, :artefacts, type: :ABSOLUTEDATETIME_RECORDED_AT, model_class: :Artefact
#  has_many :in, :artefactsFromSemanticZoomIn, type: :DATETIME_ARTEFACT_RECORDED_AT, model_class: :Artefact
#  has_one :out, :datetimeSemanticZoomOut, type: :DATETIME_SEMANTIC_ZOOM_OUT, model_class: :AbsoluteDateNode
#  has_many :in, :datetimeSemanticZoomIn,  type: :DATETIME_SEMANTIC_ZOOM_OUT, model_class: :AbsoluteDateNode
